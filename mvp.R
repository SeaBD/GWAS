...
dir.create("2022")
setwd("C:/Users/seabd4/Documents/Quebec/ULAVAL/autumn2022/Analysis_Informations_genomic/GWAS/2022/")
...
###Kinship
MVP.Data.Kin(TRUE, mvp_prefix='mvp.hmp', out='mvp')
Kinship <- attach.big.matrix("mvp.kin.desc")

###PCA
MVP.Data.PC(TRUE, mvp_prefix = "mvp.hmp", out='mvp', pcs.keep=5)
